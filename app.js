...
function renderLinkedInCampaigns() {
    const container = document.getElementById('linkedinCampaigns');
    
    const campaigns = [
        {
            name: '25Q1 - Website Remarketing',
            status: 'ACTIVE',
            budget: '$100/day',
            spend: 481.91,
            impressions: 10502,
        ...
        <div class="campaign-card">
            <div class="campaign-card-header">
                <div>
                    ...
                    <div class="campaign-budget">Budget: ${campaign.budget}</div>
                </div>
                <div class="campaign-status">${campaign.status}</div>
            </div>
            <div class="campaign-metrics">
                <div class="metric-small">
                    <div class="metric-small-label">Spend</div>
                    <div class="metric-small-value" style="color: var(--accent-amber);">$${formatNumber(campaign.spend)}</div>
                </div>
                <div class="metric-small">
                    <div class="metric-small-label">Clicks</div>
                    <div class="metric-small-value">${formatNumber(campaign.clicks)}</div>
                </div>
                <div class="metric-small">
                    <div class="metric-small-label">CTR</div>
                    <div class="metric-small-value" style="color: var(--accent-cyan);">${campaign.ctr}%</div>
                </div>
                <div class="metric-small">
                    <div class="metric-small-label">CPC</div>
                    <div class="metric-small-value">$${campaign.cpc.toFixed(2)}</div>
                </div>
                ${campaign.videoViews ? `
                <div class="metric-small" style="grid-column: 1 / -1;">
                    <div class="metric-small-label">Video Views</div>
                    <div class="metric-small-value" style="color: var(--accent-lime);">${formatNumber(campaign.videoViews)}</div>
                </div>
                ` : ''}
            </div>
        </div>
