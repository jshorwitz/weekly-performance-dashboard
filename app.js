...
const weeklyData = {
    ...
    categories: {
        'Spend': {
            icon: '💰',
            total: [48106.8, 46074.52, 48916.39, 48835.36, 54755.04, 60351.3, 62535.95, 50531.71],
            channels: {
        ...
        'Impressions': {
            icon: '👁️',
            total: [5303571, 5428627, 7093117, 7347913, 6425653, 5500001, 3090702, 2774205],
            channels: {
        ...
        'Clicks': {
            icon: '🖱️',
            total: [50513, 30110, 44229, 43537, 72165, 116157, 571320, 20796],
            channels: {
        ...
        'Conversions': {
            icon: '📈',
            total: [4500.0, 5700.0, 2923.0, 4227.0, 11337.46, 18733.85, 3540.0, 3899.2],
            channels: {
